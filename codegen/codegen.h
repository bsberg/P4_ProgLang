...
EXTERN(int, emitComputeArrayAddress, (DList instList, SymTable varSymtab, int varIndex, SymTable regSymtab, int subIndex, int key));
EXTERN(int, emitComputeVariableAddress,(DList instList, SymTable symtab, SymTable symStack, int varIndex, int key));
...
EXTERN(int, keyStuff, (SymTable symtab, SymTable symstack, char* key));
EXTERN(void, getKey, (int k));
