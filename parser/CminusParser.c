...
{
       0,   123,   123,   130,   144,   145,   148,   156,   170,   185,
     193,   197,   208,   222,   228,   235,   239,   265,   269,   272,
     278,   279,   280,   281,   284,   285,   288,   299,   303,   310,
     316,   323,   329,   335,   341,   345,   349,   355,   389,   397,
     400,   402,   406,   410,   414,   418,   424,   428,   432,   436,
     440,   444,   448,   454,   458,   462,   468,   472,   476,   482,
     486,   490,   548,   554,   566,   582,   589
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MulExpr", "Factor", "Variable", "StringConstant", "Constant", YY_NULL
};
#endif
...
#line 157 "CminusParser.y"
    {
			emitProcedurePrologue(instList, lastSymtab(stack) ,(yyvsp[(1) - (2)].symIndex), (yyvsp[(2) - (2)].offset)); 
			...
			(yyval.symIndex) = (yyvsp[(1) - (2)].symIndex); // adds full local stack 
...
#line 171 "CminusParser.y"
    {
			emitProcedurePrologue(instList, lastSymtab(stack) ,(yyvsp[(1) - (1)].symIndex), 0);
			//beginScope(stack);
			// char * dec = (char*)malloc(200);
...
#line 186 "CminusParser.y"
    {
			beginScope(stack);
			(yyval.symIndex) = SymIndex(lastSymtab(stack),(yyvsp[(2) - (5)].name));
...
#line 236 "CminusParser.y"
    { 
			(yyval.symIndex) = SymIndex(currentSymtab(stack),(yyvsp[(1) - (1)].name));
		}
    break;
...
#line 240 "CminusParser.y"
    {
			int symIndex = SymIndex(currentSymtab(stack),(yyvsp[(3) - (4)].name));
                	char* numElemString = 
			...
			symIndex = SymIndex(currentSymtab(stack),(yyvsp[(1) - (4)].name));
...
#line 266 "CminusParser.y"
    {
                        (yyval.symIndex) = SymQueryIndex(lastSymtab(stack),SYMTAB_INTEGER_TYPE_STRING);
                }
    break;
...
#line 289 "CminusParser.y"
    {
			...
			emitAssignment(instList,lastSymtab(stack),(yyvsp[(1) - (4)].symIndex),(yyvsp[(3) - (4)].symIndex));
		}
    break;
...
#line 300 "CminusParser.y"
    {
			emitEndBranchTarget(instList,lastSymtab(stack),(yyvsp[(2) - (4)].symIndex));
		}
    break;
...
#line 304 "CminusParser.y"
    {
			emitEndBranchTarget(instList,lastSymtab(stack),(yyvsp[(2) - (2)].symIndex));
		}
    break;
...
#line 311 "CminusParser.y"
    {
		   	(yyval.symIndex) = emitThenBranch(instList,lastSymtab(stack),(yyvsp[(1) - (2)].symIndex));
		}
    break;
...
#line 317 "CminusParser.y"
    {
			(yyval.symIndex) = emitIfTest(instList,lastSymtab(stack),(yyvsp[(2) - (3)].symIndex));
		}
    break;
...
#line 324 "CminusParser.y"
    {
			emitWhileLoopBackBranch(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(2) - (3)].symIndex));
		}
    break;
...
#line 330 "CminusParser.y"
    {
			(yyval.symIndex) = emitWhileLoopTest(instList,lastSymtab(stack),(yyvsp[(2) - (3)].symIndex));
		}
    break;
...
#line 336 "CminusParser.y"
    {
			(yyval.symIndex) = emitWhileLoopLandingPad(instList,lastSymtab(stack));
		}
    break;
...
#line 342 "CminusParser.y"
    {
			emitReadVariable(instList,lastSymtab(stack),(yyvsp[(3) - (5)].symIndex));
		}
    break;
...
#line 346 "CminusParser.y"
    {
			emitWriteExpression(instList,lastSymtab(stack),(yyvsp[(3) - (5)].symIndex),SYSCALL_PRINT_INTEGER);
		}
    break;
...
#line 350 "CminusParser.y"
    {
			emitWriteExpression(instList,lastSymtab(stack),(yyvsp[(3) - (5)].symIndex),SYSCALL_PRINT_STRING);
		}
    break;
...
#line 355 "CminusParser.y"
    {
					...
					sprintf(dec, "        movl %s, %%eax", (char*)SymGetFieldByIndex(lastSymtab(stack), (yyvsp[(2) - (3)].symIndex), SYM_NAME_FIELD) );
					...
					char *symReg = (char*)SymGetFieldByIndex(lastSymtab(stack), (yyvsp[(2) - (3)].symIndex), SYM_NAME_FIELD);
					int tregIndex = SymIndex(currentSymtab(stack),symReg);
					
					//freeIntegerRegister(tregIndex);
					//printf("%s %d",symReg, $2);
					// frees all regs in func before return 
					freeIntegerRegister((int)SymGetFieldByIndex(lastSymtab(stack),(yyvsp[(2) - (3)].symIndex),SYMTAB_REGISTER_INDEX_FIELD));
...
#line 411 "CminusParser.y"
    {
			(yyval.symIndex) = emitOrExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 415 "CminusParser.y"
    {
			(yyval.symIndex) = emitAndExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 419 "CminusParser.y"
    {
			(yyval.symIndex) = emitNotExpression(instList,lastSymtab(stack),(yyvsp[(2) - (2)].symIndex));
		}
    break;
...
#line 429 "CminusParser.y"
    {
			(yyval.symIndex) = emitEqualExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 433 "CminusParser.y"
    {
			(yyval.symIndex) = emitNotEqualExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 437 "CminusParser.y"
    {
			(yyval.symIndex) = emitLessEqualExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 441 "CminusParser.y"
    {
			(yyval.symIndex) = emitLessThanExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 445 "CminusParser.y"
    {
			(yyval.symIndex) = emitGreaterEqualExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 449 "CminusParser.y"
    {
			(yyval.symIndex) = emitGreaterThanExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 459 "CminusParser.y"
    {
			(yyval.symIndex) = emitAddExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 463 "CminusParser.y"
    {
			(yyval.symIndex) = emitSubtractExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 473 "CminusParser.y"
    {
			(yyval.symIndex) = emitMultiplyExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 477 "CminusParser.y"
    {
			(yyval.symIndex) = emitDivideExpression(instList,lastSymtab(stack),(yyvsp[(1) - (3)].symIndex),(yyvsp[(3) - (3)].symIndex));
		}
    break;
...
#line 483 "CminusParser.y"
    { 
			(yyval.symIndex) = emitLoadVariable(instList,lastSymtab(stack),(yyvsp[(1) - (1)].symIndex));
		}
    break;
...
#line 491 "CminusParser.y"
    {
			...
			sprintf(dec, "        call %s", (yyvsp[(1) - (3)].name) );
			...
			(yyval.symIndex) = tregIndex;
		}
    break;

  case 62:
/* Line 1792 of yacc.c  */
#line 549 "CminusParser.y"
    {
  ...
  case 63:
/* Line 1792 of yacc.c  */
#line 555 "CminusParser.y"
    {
			
			//int symIndex1 = SymQueryIndex(lastSymtab(stack),$1); // original
			int symIndex = SymQueryIndex(findSymtab(stack, (yyvsp[(1) - (1)].name)),(yyvsp[(1) - (1)].name));
			int key = isLocal(stack, (yyvsp[(1) - (1)].name));
			(yyval.symIndex) = emitComputeVariableAddress(instList, lastSymtab(stack), findSymtab(stack, (yyvsp[(1) - (1)].name)), symIndex, key); // was find sytab
  ...
  case 64:
/* Line 1792 of yacc.c  */
#line 567 "CminusParser.y"
    {
			SymTable symtab = findSymtab(stack, (yyvsp[(1) - (4)].name));
			int key = isLocal(stack, (yyvsp[(1) - (4)].name));
			...
			// dlinkAppend(instList , temp );
			// changes here
			(yyval.symIndex) = emitComputeArrayAddress(instList,symtab,symIndex,lastSymtab(stack),(yyvsp[(3) - (4)].symIndex), key);	
  ...
  case 65:
/* Line 1792 of yacc.c  */
#line 583 "CminusParser.y"
    { 
			int symIndex = SymIndex(lastSymtab(stack),(yyvsp[(1) - (1)].name));
			(yyval.symIndex) = emitLoadStringConstantAddress(instList,dataList,lastSymtab(stack),symIndex); 
		}
    break;

  case 66:
/* Line 1792 of yacc.c  */
#line 590 "CminusParser.y"
    { 
			int symIndex = SymIndex(lastSymtab(stack),(yyvsp[(1) - (1)].name));
			(yyval.symIndex) = emitLoadIntegerConstant(instList,lastSymtab(stack),symIndex); 
